...
#error ImageResizeOperation is ARC only. Either turn on ARC for the project or use -fobjc-arc flag
#endif
...
@interface ImageResizeOperation ()
    ...
    @autoreleasepool {
        ...
        if (self.writePath) {
            ...
            if ([[self.writePath lowercaseString] hasSuffix:@".jpg"]) {
                ...
                outputData = UIImageJPEGRepresentation(self.result, self.JPEGcompressionQuality ? self.JPEGcompressionQuality : 0.5f);
            } else {
