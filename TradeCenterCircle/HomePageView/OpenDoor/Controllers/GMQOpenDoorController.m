//
//  GMQOpenDoorController.m
//  TradeCenterCircle
//
//  Created by fyb on 2017/2/13.
...
@interface GMQOpenDoorController ()<OpenDoorToolDelegate,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
- (void)openDoorTool:(OpenDoorTool *)openDoorTool didConnectBlueToothWithBabyBluetooth:(BabyBluetooth *)babyBlueTooth andBTName:(NSString *)btName
{
    ...
    [SVProgressHUD showInView:self.view status:successLog];
...
//        [SVProgressHUD showInfoWithStatus:@"蓝牙断开"];
        [SVProgressHUD dismissWithSuccess:@"蓝牙断开"];
    });
