...
@interface IdentityverifyViewController ()
...
-(void)creatUI
{
    ...
    mesLabel.text = @"您还没有验证身份信息，还不能使用该功能,请先验证";
    ...
    [goBtn setBackgroundImage:[UIImage imageNamed:@"btn_quyanzheng"] forState:UIControlStateNormal];
...
{
    HouseholdsController *Households = [[HouseholdsController alloc]init];
    Households.space_id = [USER_DEFAULT objectForKey:kSpace_id]  ;
    Households.community_id = [USER_DEFAULT objectForKey:kCommunityId] ;
    [self.navigationController pushViewController:Households animated:YES];
